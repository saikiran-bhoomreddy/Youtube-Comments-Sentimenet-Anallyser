...
def main_method(videolink):
  ...
  print(" ==> NUMBER OF POSITIVE COMMENTS ARE : ",len(data_pos),"\n")
  print(" ==> NUMBER OF NEGATIVE COMMENTS ARE : ",len(data_neg),"\n")

  perpos=((len(data_pos)/len(data))*100)
  perneg=((len(data_neg)/len(data))*100)
  print(" ==> PERCENTAGE OF COMMENTS THAT ARE POSITIVE : ",perpos,"%\n")
  print(" ==> PERCENTAGE OF COMMENTS THAT ARE NEGATIVE : ",perneg,"%\n")
  labels = 'Positive', 'Negative '

  sizes = [len(data_pos), len(data_neg)]
  ...
  plt.title("Overall Analysis of video comments")
...
def main():
  print("testing")
  videolink="https://www.youtube.com/watch?v=ZELV_th4dG0"
  main_method(videolink)
